...
import { Card, Table, Badge, Button, Pagination, Spinner, Modal, Form, Alert } from 'react-bootstrap';
              ...
              {filteredUsers.length === 0 ? (
                ...
                filteredUsers.map((user) => (
                  <tr key={user.id}>
                    ...
                    <td>{user.email}</td>
                    <td style={{ fontFamily: 'monospace' }}>{user.accountNumber}</td>
                    <td className="text-end">{formatCurrency(user.balance)}</td>
                    <td>
